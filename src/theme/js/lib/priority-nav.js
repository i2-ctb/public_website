...
(function (root, factory) {
    ...
    var defaults = {
        ...
        navDropdownClassName:       "more-dropdown", // class used for the dropdown.
        navDropdownToggleClassName: "more-dropdown-toggle", // class used for the dropdown toggle.
    ...
    var prepareHtml = function (_this, settings) {
        ...
        navDropdown.classList.add("priority-nav-dropdown");

        navDropdownToggle.classList.add(settings.navDropdownToggleClassName);
        navDropdownToggle.classList.add("priority-nav-dropdown-toggle");

        toggleWrapper.classList.add(settings.navDropdownClassName+"-wrapper");
        toggleWrapper.classList.add("priority-nav-wrapper");
    ...
    priorityNav.doesItFit = function (_this) {
        ...
        (debounce(function () {
            ...
            /**
             * If the desktop menu layout is currently in use
             */
            ...
            /**
             * If the mobile menu layout is currently in use
             */
            } else {
                /**
                 * Keep executing until all menu items that are able to move back are moved
                 */
                while (viewportWidth < settings.breakPoint && breaks[identifier].length > 0) {
                    //move item to menu
                    priorityNav.toMenu(_this, identifier);
                }
            }
    ...
    var showToggle = function (_this, identifier) {
        if (breaks[identifier].length < 1) {
             ...
             * Set aria attributes for accessibility
             */
            _this.querySelector(".priority-nav-wrapper").setAttribute("aria-haspopup", "false");
             ...
             * Set aria attributes for accessibility
             */
            _this.querySelector(".priority-nav-wrapper").setAttribute("aria-haspopup", "true");
        }
    };
    ...
    var listeners = function (_this, settings) {
        ...
        /*
         * Remove when the header search is opened
         */
        document.addEventListener("desktop-search-toggle", function (event) {
            _this.querySelector(navDropdown).classList.remove("show");
            _this.querySelector(navDropdownToggle).classList.remove("is-open");
            _this.classList.remove("is-open");
        });
